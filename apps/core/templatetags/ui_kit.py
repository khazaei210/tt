...
_ICON_PATHS = {
    ...
    # Double chevron, not the crossing arrows-right-left glyph: that one's
    # diagonal arrowheads collide into an illegible blob at hint-text size
    # (h-3.5). Directional, so callers must flip it with `rtl:-scale-x-100`
    # for the app's RTL layout.
    "swipe": "M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5",
}
