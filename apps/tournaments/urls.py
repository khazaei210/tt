...
urlpatterns = [
    ...
    path(
        ...
        views.stage_generate_all_schedules,
        name="stage_generate_all_schedules",
    ),
    ...
    path(
        "competitions/<int:competition_pk>/participants/seed-by-rating/",
        views.competition_seed_by_rating,
        name="competition_seed_by_rating",
    ),
    path(
