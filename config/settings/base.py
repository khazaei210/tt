...
Environment-specific settings (dev.py, prod.py) import * from this module
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.core.context_processors.theme_options",
            ],
        },
    },
]
...
# Persian is the primary interface language; English is the secondary
# fallback. See CLAUDE.md section 23.
